        ...
        {analysisData.transcript && analysisData.transcript.length > 0 && (
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              <MessageSquare className="w-5 h-5 text-purple-500" />
              <h2 className="text-lg font-semibold text-gray-900">Full Conversation Transcript</h2>
              <span className="text-sm text-gray-500">({analysisData.transcript.length} messages)</span>
            </div>
            <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
              {analysisData.transcript.map((message: any, index: number) => (
                <div
                  key={index}
